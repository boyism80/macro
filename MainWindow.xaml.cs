...
namespace macro
{
    ...
    {
        public static readonly string CONFIG_PATH = "config.dat";
        ...
        public MainWindow()
        {
            Model = macro.Model.MainWindow.Load(CONFIG_PATH) ?? new macro.Model.MainWindow();
            InitializeComponent();
        }
        ...
        {
            var dbContext = DataContext as ViewModel.MainWindow;
            ...
            switch ((uint)wParam)
            {
                case 0x20B:
                    ...
                    if (xbutton == 1)
                        dbContext.OnXButton1Down();
                    else if (xbutton == 2)
                        dbContext.OnXButton2Down();

                    break;

                case 520:
                    dbContext.OnWheelClick();
                    break;
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            var vm = new ViewModel.MainWindow(Model)
            {
                SetMinimizeCommand = new RelayCommand(_ => WindowState = System.Windows.WindowState.Minimized),
                SetMaximizeCommand = new RelayCommand(_ => WindowState ^= System.Windows.WindowState.Maximized),
